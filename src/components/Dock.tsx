    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Contenu des icônes */}
          <motion.div
            className="absolute top-0 left-0 w-full h-12 flex items-center justify-center gap-8 px-6"
            animate={{
